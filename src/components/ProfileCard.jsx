      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                'radial-gradient(circle at top, rgba(25,35,65,0.95) 0%, rgba(10,18,40,0.98) 45%, rgba(4,8,18,1) 100%)',
              borderRadius: cardRadius,
              display: 'grid',
              gridArea: '1 / -1'
            }}
          >
            {/* ── Avatar image: full-body, anchored bottom, no crop ── */}
            <div
              style={{
                position: 'absolute',
                // top boundary: sits just below the title block (~120px for name+title)
                top: '140px',
                // bottom boundary: sits just above the footer info bar (~90px tall)
                bottom: '90px',
                left: 0,
                right: 0,
                display: 'flex',
                alignItems: 'flex-end',   // anchor person to the bottom
            ...
            >
              <img
                ...
                loading="lazy"
                style={{
                  // contain keeps full body visible, no cropping
                  width: '100%',
                  height: '100%',
                  objectFit: 'contain',
          ...
          {/* ── Name & title text (on top of image) ── */}
          <div
